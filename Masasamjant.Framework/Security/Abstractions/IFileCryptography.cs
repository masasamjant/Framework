namespace Masasamjant.Security.Abstractions
{
    ...
    public interface IFileCryptography
    {
        ...
        Task DencryptAsync(string sourceFile, string destinationFile, string password, Salt salt, bool overwriteDestination = false, CancellationToken cancellationToken = default);
    }
}
