namespace Masasamjant.Security.Abstractions
{
    ...
    /// <summary>
    /// Represents component that provides encryption and decryption of streams using <typeparamref name="TCryptoKey"/> key.
    /// </summary>
    /// <typeparam name="TCryptoKey">The type of the <see cref="CryptoKey"/>.</typeparam>
    public interface IStreamCryptography<TCryptoKey> : IStreamCryptography, ICryptography<TCryptoKey>
