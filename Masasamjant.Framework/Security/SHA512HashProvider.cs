...
{
    /// <summary>
    /// Represents <see cref="HashProvider"/> that use SHA-512 algorithm.
    /// </summary>
    public sealed class SHA512HashProvider : HashProvider
    {
        /// <summary>
        /// Gets the name of implemented algorithm. Always 'SHA-512'.
        /// </summary>
        public override string Algorithm => "SHA-512";
        ...
        {
            return await SHA512.HashDataAsync(source);
        }
    }
}
